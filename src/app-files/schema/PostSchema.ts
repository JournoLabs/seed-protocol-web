import { integer, sqliteTable, text, uniqueIndex } from 'drizzle-orm/sqlite-core'
  ...
  import { identities } from './identitySchema'
...
export const posts = sqliteTable('posts', {
  ...
  export const postData = sqliteTable('posts_data', {
  id: integer('id').unique().primaryKey(),
  ...
  export const postsDataRelations = relations(postData, ({ one }) => ({
  posts: one(posts),
  }));
...
export type postsType = posts.$inferSelect
